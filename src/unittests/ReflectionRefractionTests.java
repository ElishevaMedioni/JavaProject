...
//						.setKL(4E-4).setKQ(2E-5));
		...
		ImageWriter imageWriter = new ImageWriter("moonWithSS", 600, 600);
		Render render = new Render() //
				.setImageWriter(imageWriter) //
				.setCamera(camera) //
				.setRayTracerBase(new RayTracerSuperSampling(scene))
				.setMultithreading(3)
				.setDebugPrint();
		...
		private final Camera camera = new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1),
				new Vector(0, 1, 0)) //
		...
		public void teapot1() {
			...
			scene1.lights.add(new PointLight(new Color(500, 500, 500), new Point3D(100, 0, -100)) //
					.setKQ(0.000001));
